...
from cmem_plugin_validation.example_transform import Lifetime
from cmem_plugin_validation.example_workflow import DollyPlugin
from tests.utils import TestExecutionContext, needs_cmem

PROJECT_NAME = "validation_test_project"
...
def di_environment() -> object:
    ...
    with io.StringIO("validation plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
