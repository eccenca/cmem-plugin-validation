...
# Releasing cmem-plugin-validation
...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-validation/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-validation/).
